...
def generate_temperature(rrdfile, observer):
	...
	for sched in ['hourly','halfday' , 'daily' , 'weekly', 'monthly']:
		...
		"GPRINT:temp:LAST:Cur\:%5.1lf C\j",
		"GPRINT:temp:AVERAGE:Avg\:%5.1lf C\j",
		"GPRINT:tmin:MIN:Min\:%5.1lf C\j",
		"GPRINT:tmax:MAX:Max\:%5.1lf C\j",
...
def generate_pressure(rrdfile, observer):
	...
	for sched in ['hourly','halfday' , 'daily' , 'weekly', 'monthly']:
		...
		"AREA:dusktilldawn#CCCCCC",
		"AREA:dawntilldusk#CCCCCC",
		"GPRINT:pressure:LAST:Cur\:%5.1lf hPa\j",
		"GPRINT:pressure:AVERAGE:Avg\:%5.1lf hPa\j",
		"GPRINT:pmin:MIN:Min\:%5.1lf hPa\j",
